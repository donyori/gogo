...
// AutoWrap, AutoWrapSkip, AutoWrapCustom, AutoNew, and AutoNewCustom.
//
// It records the information of the function that reports the error.
//
// Its method Unwrap returns the error wrapped by
// AutoWrap, AutoWrapSkip, AutoWrapCustom, AutoNew, or AutoNewCustom.
// It is never a nil error.
//
// The client cannot implement this interface.
type AutoWrappedError interface {
	ErrorUnwrap

	// Root finds and returns the first error along the Unwrap error tree
	// that is not generated by AutoWrap, AutoWrapSkip, AutoWrapCustom,
	// AutoNew, or AutoNewCustom.
	// The result is never a nil error.
	Root() error
...
type autoWrappedError struct {
	err      error                // the wrapped error, must never be nil
...
// AutoWrap finds the first error that is not an AutoWrappedError
// along the Unwrap error tree and uses its error message instead.
//
...
//
// In particular, if err is an AutoWrappedError,
// AutoWrapSkip finds the first error that is not an AutoWrappedError
// along the Unwrap error tree and uses its error message instead.
//
...
//
// In particular, if err is an AutoWrappedError,
// AutoWrapCustom finds the first error that is not an AutoWrappedError
// along the Unwrap error tree and uses its error message instead.
//
// skip is the number of stack frames to ascend,
...
// UnwrapAllAutoWrappedErrors repeatedly unwraps err
// until the result is not an AutoWrappedError,
// and then returns the result and true if err is an AutoWrappedError.
//
...
// and unwraps err until the result is not an AutoWrappedError
// if err is an AutoWrappedError.
//
