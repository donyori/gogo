...
//
// In particular, if err is generated by functions AutoWrap, AutoWrapSkip,
// or AutoWrapCustom, AutoWrap will find the first error that is not
// generated by these two functions along the Unwrap error chain and
...
// generated by these two functions along the Unwrap error chain and use
...
func AutoWrapCustom(err error, ms ErrorMessageStrategy, skip int, exclusions ErrorReadOnlySet) error {
	...
	var aeType *autoWrapError
	wrapped := err
	for stderrors.As(wrapped, &aeType) {
		wrapped = stderrors.Unwrap(wrapped)
	}

	ae.msg = AutoMsgCustom(wrapped.Error(), ms, skip+1)
	return ae
}

// autoWrapError is the error generated by functions AutoWrap or AutoWrapCustom.
//
...
func (ae *autoWrapError) Error() string {
	return ae.msg
}
