...
func TestBufferedReader_IterLines(t *testing.T) {
	...
	if outErr != nil {
		...
		t.Errorf("got %d lines; want %d", i, numLine)
	}
...
func TestBufferedReader_IterCountLines(t *testing.T) {
	...
	if outErr != nil {
		...
		t.Errorf("got %d lines; want %d", ctr, numLine)
	}
...
// numLine is the number of lines in data generated by
// function buildLongLineAndInputData.
const numLine int = 4

// buildLongLineAndInputData generates a long string, longLine,
// with tens of thousands of bytes, without end-of-line characters.
//
// It also generates data with numLine repetitions of longLine
